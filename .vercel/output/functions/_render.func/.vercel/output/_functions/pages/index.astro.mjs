...
const FriendlyCaptcha = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      if (widget.current != void 0) widget.current.reset();
    };
  }, [container]);
  ...
  useEffect((solution) => {
    ...
    formData.append(
      "secret",
      "A1PRQ33PS7SCI3DQTC01CK69S7DHOKVLJ6KA529POH37NP6QLDCA633QDN"
    );
